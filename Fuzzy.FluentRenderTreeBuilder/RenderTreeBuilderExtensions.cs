...
namespace Fuzzy.Components
{
	...
	public static class RenderTreeBuilderExtensions
	{
		...
		/// <param name="initialIndent">If <paramref name="prettyPrint"/> is <c>true</c>, the initial indentation
		/// level for block elements.</param>
		/// <param name="maxPerLine">
		/// The maximum number of frames that can be generated per source code line (including pretty printing whitespace).
		/// </param>
		/// <param name="logger">
		/// The optional <see cref="ILogger{TCategoryName}"/> implementation to use for logging.
		/// </param>
		public static FluentRenderTreeBuilder Build(this RenderTreeBuilder builder,
				...
				ILogger? logger = null)
			=> new (builder, prettyPrint, initialIndent, maxPerLine, logger);
	}
}
