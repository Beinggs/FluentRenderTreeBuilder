...
namespace Fuzzy.Components
{
	...
	/// balancing of <see cref="OpenRegion"/>, <see cref="OpenElement"/>, and <see cref="xComponent"/>
	...
	/// <para>
	/// Next, the <c>builder.OpenComponent()</c> call generated by the <see cref="xComponent"/>
...
#pragma warning restore BL0006 // Do not use RenderTree types
		...
		public FluentRenderTreeBuilder Close(bool prettyPrint = true,
				[CallerLineNumber] int line = 0)
		{
			// pop this first so PrettyPrint below has correct indent
		...
		public FluentRenderTreeBuilder Id(string value, [CallerLineNumber] int line = 0)
		{
			_builder.AddAttribute(GetSequence(line), "id", value);
			return this;
		}
